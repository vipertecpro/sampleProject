<nav id="navbar-desctop" class="navbar navbar-desctop">
    <div class="d-flex position-relative w-100">
        ...
        <ul class="navbar-nav-desctop mr-auto d-none d-lg-block">
            ...
            <li><a class="nav-link" href="{!! route('front.show',['news']) !!}">News</a></li>
            <li><a class="nav-link" href="{!! route('front.show',['blog']) !!}">Blogs</a></li>
            <li><a class="nav-link" href="{!! route('front.show',['product']) !!}">Products</a></li>
        </ul>
